(() => {
  const STYLE_ID = "su-ecosystem-unified-style-v2";
  const apply = () => {
    ...
    if (!document.getElementById(STYLE_ID)) {
      ...
      style.textContent = `
        ...
        .su-loto-actions{grid-template-columns:1fr 1fr!important;gap:10px!important}.su-loto-actions button{width:100%!important;min-height:46px!important;padding:12px 14px!important;background:#f3edf6!important;color:#3d1748!important;border:1px solid #e2d4e8!important;font-size:.96rem!important}
        ...
        #su-loto-signout{grid-column:1/-1;background:#fff1f2!important;color:#b42335!important;border-color:#fecdd3!important}@media(max-width:520px){.su-loto-grid,.su-loto-actions{grid-template-columns:1fr!important}#su-loto-signout{grid-column:auto}.su-eco-head{padding-right:78px}}
      `;
      document.head.appendChild(style);
    }

    if (!card.dataset.unifiedV2) {
      card.dataset.unifiedV2 = "true";
