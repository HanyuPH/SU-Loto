(() => {
"use strict";
const C={app:'SU Loto',betsKey:'su-loto-c2-contest-bets-v1',statusKey:'su-loto-c2-status-v4',lockKey:'su-loto-c2-contest-locks-v1',ids:{root:'su-loto-contest-bets',number:'su-loto-bet-contest',history:'su-loto-bet-history',save:'su-loto-save-contest-bets',close:'su-loto-close-contest-bets',reopen:'su-loto-reopen-contest-bets'}},BETS_KEY=C.betsKey,STATUS_KEY=C.statusKey,LOCK_KEY=C.lockKey;
